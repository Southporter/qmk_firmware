...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, RAISE,   _______, _______, _______,    KC_MNXT,    KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_NAV] = LAYOUT_planck_grid(
    ...
    _______, KC_LALT, KC_LGUI,  KC_LSFT, KC_LCTL, KC_NO,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,   CW_TOGG,
    _______, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_HOME, KC_PGUP, KC_PGDN, KC_END,  _______,
 ...
 * |      |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | ALT  |  GUI | SHIFT| CTRL |      |      |   4  |   5  |   6  |      |CPS_WD|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |   1  |   2  |   3  |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |          0  |   0  |   .  | Vol- | Vol+ | Play |
...
[_NUM] = LAYOUT_planck_grid( 
    ...
    _______, KC_LALT, KC_LGUI,  KC_LSFT, KC_LCTL, KC_NO,   KC_NO,   KC_4,    KC_5,    KC_6,    KC_NO,   _______,
    _______, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_1,    KC_2,    KC_3,    KC_NO,   _______,
